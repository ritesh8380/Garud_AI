  ...
  return `
    ...
    *, *::before, *::after {
    ...
    .shell {
      ...
      align-items: stretch;
      animation: shellIn 0.4s cubic-bezier(.2,.8,.3,1) both;
    }
    @keyframes shellIn {
      from {
        opacity: 0;
    ...
    .sidebar {
      ...
      height: 100%;
      background: ${t.bg};
      border-right: 1px solid ${t.topbarBorder};
      display: flex;
      flex-direction: column;
      transition: margin-left 0.25s ease, background 0.3s, border-color 0.3s;
    }
    .sidebar.closed {
      margin-left: -260px;
    }
    ...
    .sidebar-star-badge:hover {
      background: ${t.inputBg};
      color: ${t.text};
    }
    .sidebar-star-badge.active {
      color: #f5b942;
    ...
    .sidebar-item:hover .sidebar-item-actions, .sidebar-item.active .sidebar-item-actions {
      opacity: 1;
    }
    .sidebar-icon-btn {
      width: 22px;
    ...
    .sidebar-note {
      ...
      color: ${t.dimText};
      text-align: center;
      border-top: 1px solid ${t.topbarBorder};
    ...
    .avatar-btn {
      ...
      border-radius: 50%;
      border: 1px solid ${t.inputBorder};
      background: linear-gradient(135deg,#ab68ff,#8b3cff);
      color: #fff;
      font-family: 'Syne', sans-serif;
      font-size: 13px;
      font-weight: 800;
    ...
    .avatar-btn:hover {
      transform: translateY(-1px);
      box-shadow: 0 4px 14px rgba(171,104,255,0.35);
    }
    .account-menu {
      position: absolute;
      top: 40px;
      ...
      animation: menuIn 0.16s cubic-bezier(.2,.8,.3,1) both;
      z-index: 20;
    }
    @keyframes menuIn {
      from {
    ...
    .welcome {
      ...
      text-align: center;
      padding: 20px 16px;
      animation: wIn 0.5s cubic-bezier(.2,.8,.3,1) both;
    }
    @keyframes wIn {
      from {
        opacity:0;
    ...
    .msg-block {
      padding: 18px 0;
      animation: mIn 0.35s cubic-bezier(.2,.8,.2,1) both;
    }
    @keyframes mIn {
      from {
        opacity:0;
    ...
    .user-pill {
      ...
      border: 1px solid ${t.userPillBorder};
      border-radius: 20px;
      padding: 12px 18px;
      font-size: 15px;
      line-height: 1.65;
    ...
    .bot-avatar {
      ...
      height: 26px;
      border-radius: 6px;
      background: ${t.avatarBot}18;
      border: 1px solid ${t.avatarBot}30;
      display: flex;
      align-items: center;
      justify-content: center;
      font-size: 14px;
      flex-shrink: 0;
      margin-top: 3px;
      animation: avatarPop 0.35s cubic-bezier(.34,1.56,.64,1) both;
    }
    @keyframes avatarPop {
      from {
        transform: scale(0.6);
    ...
    .speak-btn.speaking {
      color: ${t.avatarBot};
      border-color: ${t.avatarBot}55;
      background: ${t.avatarBot}14;
    }
    .speak-btn:disabled {
      opacity: 0.4;
      cursor: not-allowed;
    ...
    .input-box {
      ...
      gap: 10px;
      transition: border-color 0.2s ease, background 0.3s, box-shadow 0.2s ease;
    }
    .input-box:focus-within {
      border-color: ${t.inputHoverBorder};
      box-shadow: 0 0 0 3px ${t.avatarBot}14;
    }
    textarea {
      flex: 1;
      background: none;
    ...
    .send-btn {
      ...
      justify-content: center;
      flex-shrink: 0;
      transition: opacity 0.15s ease, transform 0.12s ease, background 0.3s;
    }
    ...
    .modal {
      ...
      position: relative;
      text-align: center;
      animation: slideU 0.25s cubic-bezier(.34,1.56,.64,1) both;
      box-shadow: 0 24px 60px rgba(0,0,0,0.4);
      transition: background 0.3s, width 0.2s ease;
    }
    .modal.wide {
    ...
    .mode-toggle-btn {
      ...
      align-items: center;
      justify-content: center;
      box-shadow: 0 0 0 3px var(--glow), 0 0 10px var(--glow), 0 2px 8px rgba(0,0,0,0.2);
    ...
    @keyframes modeGlow {
      0%,100% {
        box-shadow: 0 0 0 3px var(--glow), 0 0 8px var(--glow), 0 2px 8px rgba(0,0,0,0.2);
      }
      50% {
        box-shadow: 0 0 0 3px var(--glow), 0 0 16px var(--glow), 0 2px 8px rgba(0,0,0,0.2);
      }
    }
    .mode-row {
      position: absolute;
      ...
      animation: modeRowIn 0.2s cubic-bezier(.2,.8,.3,1) both;
      z-index: 6;
    }
    ...
    .mode-row-item {
      ...
      cursor: pointer;
      font-family: 'Inter', sans-serif;
      transition: background 0.15s ease, color 0.15s ease, border-color 0.15s ease, transform 0.12s ease, box-shadow 0.2s ease;
    }
    .mode-row-item:hover {
      background: ${t.inputBg};
      color: ${t.text};
    ...
    .mode-row-item:active {
      transform: translateY(0) scale(0.96);
    }
    .mode-row-item.active {
      color: ${t.text};
      border-color: transparent;
      box-shadow: 0 0 0 2px var(--glow), 0 0 14px var(--glow);
    }
    .mode-row-icon {
      font-size: 19px;
      line-height: 1;
    ...
    @media (prefers-reduced-motion: reduce) {
      ...
      .chip, .send-btn, .icon-btn, .dev-btn, .account-menu, .bot-avatar, .mode-toggle-btn, .mode-row, .mode-row-item {
    ...
    @media (max-width: 480px) {
      ...
      .mode-toggle-btn, .attach-btn, .send-btn {
        width: 32px;
        height: 32px;
      }
      .mode-row-item {
